...
%%% WEN: This section is misleading. If we were to talk about the language a*b*,
%%%      and we pass in \maxAmb{n} over $\{a,b\}$, then we get back \maxAmb{n}.
%%%      However, this also contains, as possible strings, abab..abab, which is
%%%      definitely not in the language a*b*.
