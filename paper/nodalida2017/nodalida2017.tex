...
The word forms are now actual words, and the \t{opt\_POS} only include the actual analyses of those words.
...
Moreover, the real-life ambiguous cohorts are not \maxAmb{n}, but some much 
smaller subset of $\Sigma$. Despite the limitation, we are still hopeful
